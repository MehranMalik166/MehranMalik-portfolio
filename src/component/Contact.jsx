...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    // yha errors show and submit stop 
  ...
  return (
    <div id='#contact' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <textarea rows="6" placeholder="Enter your message" className="w-full py-2 focus:ring-1 outline-none border border-gray-300 dark:border-white/30 rounded-md bg-white mb-6 dark:bg-darkHover/30 px-4 md:px-10" required name="message"></textarea>
        <p>{errors.message}</p>
        ...
        />
        <button type='submit' className="py-2 px-8 mt-10 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border dark:border-white/30 dark:hover:bg-darkHover">
          Submit now
