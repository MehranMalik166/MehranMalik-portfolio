...
function Navbar() {
  ...
  // 👇 smart navigation: agar Home pe nahi ho to pehle Home bhejo, fir scroll karo
    ...
    <>
      ...
      <nav ref={navRef} className='w-full flex items-center justify-between dark:bg-darkTheme fixed z-50 px-5 lg:px-8 xl:px-[8%] py-4 '>
        ...
        <ul ref={navLinkRef} className='hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50 font-Ovo dark:border dark:border-white/30 dark:bg-transparent '>
          <li><a href="#top" onClick={goToSection('top')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>Home</a></li>
          <li><a href="#about" onClick={goToSection('about')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>About me</a></li>
          <li><a href="#experience" onClick={goToSection('experience')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>Experience</a></li>
          <li><a href="#service" onClick={goToSection('service')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>Services</a></li>
          <li><a href="#project" onClick={goToSection('project')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>Project</a></li>
          <li><a href="#contact" onClick={goToSection('contact')} className='hover:text-gray-500 dark:hover:text-gray-300 transition cursor-pointer'>Contact me</a></li>
        </ul>
        ...
        <div className='flex items-center gap-6'>
          ...
          <a href="#contact" onClick={goToSection('contact')} className="hidden lg:flex items-center gap-3 px-8 py-1.5 border border-gray-300 hover:bg-slate-100/70 dark:hover:bg-darkHover rounded-full ml-4 font-Ovo dark:border-white/30 cursor-pointer">
            Contact
        ...
        <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 font-Ovo dark:bg-darkHover dark:text-white '>
          ...
          <li><a href="#top" onClick={goToSection('top')}>Home</a></li>
          <li><a href="#about" onClick={goToSection('about')}>About me</a></li>
          <li><a href="#experience" onClick={goToSection('experience')}>Experience</a></li>
          <li><a href="#service" onClick={goToSection('service')}>Services</a></li>
          <li><a href="#project" onClick={goToSection('project')}>Project</a></li>
          <li><a href="#contact" onClick={goToSection('contact')}>Contact me</a></li>
        </ul>
      </nav>
    </>
  )
